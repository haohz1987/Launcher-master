...
public class LauncherFiles {
    ...
    public static final String SHARED_PREFERENCES_KEY = "com.handpay.launch.prefs";
    public static final String WALLPAPER_CROP_PREFERENCES_KEY =
            "com.handpay.launch.WallpaperCropActivity";
    public static final String MANAGED_USER_PREFERENCES_KEY = "com.handpay.launch.managedusers.prefs";
    ...
    public static final List<String> OBSOLETE_FILES = Collections.unmodifiableList(Arrays.asList(
            ...
            "com.handpay.launch.compat.PackageInstallerCompatV16.queue"));
}
