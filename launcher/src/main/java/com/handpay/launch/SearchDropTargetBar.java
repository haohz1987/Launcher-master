...
//    private ButtonDropTarget mUninstallDropTarget;
    ...
    public SearchDropTargetBar(final Context context, AttributeSet attrs, int defStyle) {
...
//        mDropTargetBar.setAlpha(0f);
        ...
        mInfoDropTarget.setVisibility(VISIBLE);
...
//                v.setAlpha(alpha);
    ...
    public void onDragStart(DragSource source, Object info, int dragAction) {
        ...
        mInfoDropTarget.setVisibility(GONE);
    }
